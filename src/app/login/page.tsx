  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm">
        ...
        {/* Card */}
        <div className="bg-surface border border-[#2e3147] rounded-2xl p-8 shadow-2xl">
          <h1 className="text-xl font-bold mb-1">כניסה למערכת</h1>
          <p className="text-sm text-muted mb-6">הזן את פרטי הכניסה שלך</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium rounded-lg py-2.5 text-sm transition-colors mt-2"
            >
              {loading ? (
                <>
