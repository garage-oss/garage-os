...
const ROLES = [
  ...
  { value: 'SERVICE_ADVISOR',label: 'יועץ שירות' },
  ...
  return (
    <div className="bg-[#1a1d27] border border-[#2e3147] rounded-xl p-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative">
              ...
              <input name="email" type="email" required dir="ltr" placeholder="user@garage.co.il"
        ...
        {success && <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm rounded-lg px-3 py-2.5">{success} — שתף את קישור ההזמנה</div>}
