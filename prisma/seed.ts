...
async function main() {
  ...
  await prisma.vehicle.upsert({
    ...
    update: {},
    create: { id: 'veh-8', plate: '222-33-444', make: 'Mitsubishi', model: 'Outlander', year: 2020, color: 'לבן', engine: '2.4L', fuelType: 'HYBRID', transmission: 'AUTOMATIC', customerId: sara.id, mileage: 43000, notes: 'חיבור היברידי — טעינה 220V בלבד' },
  })
  await prisma.vehicle.upsert({
  ...
  const sup1 = await prisma.supplier.upsert({
    ...
    create: {
      id: 'sup-1',
      name: 'טכנו-חלקים בע"מ',
      contactName: 'משה אברמוביץ',
      phone: '03-5551234',
      email: 'orders@techno-parts.co.il',
      address: 'אזור תעשייה צפוני, פתח תקווה',
      notes: 'אספקה תוך 24 שעות לחלקי מנוע ובלמים',
    },
  })
  const sup2 = await prisma.supplier.upsert({
    ...
    create: {
      ...
      contactName: 'רחל כץ',
      phone: '08-6667890',
      email: 'rachel@autopro.co.il',
      address: 'רחוב המסחר 7, אשדוד',
      notes: 'חלקי מקור יפני ואירופאי — הזמנה מינימלית 500 ₪',
    },
  })
  const sup3 = await prisma.supplier.upsert({
    ...
    create: {
      id: 'sup-3',
      name: 'אל-קאר שרות',
      contactName: 'אחמד חסן',
      phone: '04-8889012',
      email: 'info@alcar.co.il',
      address: 'רחוב הנחושת 3, חיפה',
      notes: 'מתמחה בחלקי מיזוג ומערכות קירור',
    },
  })
  const sup4 = await prisma.supplier.upsert({
    ...
    create: {
      id: 'sup-4',
      name: 'פרימיום-אוטו',
      contactName: 'גיל שפירא',
      phone: '02-7771111',
      email: 'gil@premiumauto.co.il',
      address: 'קניון הגדול, ירושלים',
      notes: 'ייבוא חלקים גרמניים — BMW, Mercedes, VW',
    },
  })
  ...
  const parts = [
    {
      id: 'part-1', sku: 'FLT-OIL-001', name: 'פילטר שמן — יוניברסל', category: 'פילטרים',
      manufacturer: 'Bosch', supplierId: sup1.id,
      costPrice: 18, salePrice: 35, quantity: 45, minQuantity: 10, location: 'מדף A1',
    },
    {
      id: 'part-2', sku: 'FLT-AIR-002', name: 'פילטר אוויר — טויוטה קורולה', category: 'פילטרים',
      manufacturer: 'Toyota OEM', supplierId: sup2.id,
      costPrice: 55, salePrice: 95, quantity: 12, minQuantity: 5, location: 'מדף A2',
    },
    {
      id: 'part-3', sku: 'BRK-PAD-001', name: 'רפידות בלם קדמי — יוניברסל', category: 'בלמים',
      manufacturer: 'Brembo', supplierId: sup1.id,
      costPrice: 90, salePrice: 160, quantity: 8, minQuantity: 6, location: 'מדף B1',
      notes: 'מתאים לרוב דגמי ה-2015 ומעלה',
    },
    {
      id: 'part-4', sku: 'BRK-DSC-001', name: 'דיסק בלם קדמי — פרמיום', category: 'בלמים',
      manufacturer: 'Brembo', supplierId: sup1.id,
      costPrice: 140, salePrice: 240, quantity: 3, minQuantity: 4, location: 'מדף B2',
    },
    {
      id: 'part-5', sku: 'ENG-OIL-5W30', name: 'שמן מנוע 5W-30 — 4 ליטר', category: 'שמנים',
      manufacturer: 'Castrol', supplierId: sup2.id,
      costPrice: 55, salePrice: 85, quantity: 30, minQuantity: 10, location: 'מחסן שמנים',
    },
    {
      id: 'part-6', sku: 'ENG-OIL-0W20', name: 'שמן מנוע 0W-20 היברידי — 4 ליטר', category: 'שמנים',
      manufacturer: 'Mobil 1', supplierId: sup2.id,
      costPrice: 85, salePrice: 130, quantity: 2, minQuantity: 5, location: 'מחסן שמנים',
      notes: 'לרכבים היברידיים בלבד',
    },
    {
      id: 'part-7', sku: 'AC-GAS-134A', name: 'גז מקרר R-134a — 1 ק"ג', category: 'מיזוג אוויר',
      manufacturer: 'DuPont', supplierId: sup3.id,
      costPrice: 45, salePrice: 90, quantity: 7, minQuantity: 3, location: 'מדף C1',
    },
    {
      id: 'part-8', sku: 'IGN-PLG-001', name: 'מצתים — סט 4 יחידות', category: 'מצתים',
      manufacturer: 'NGK', supplierId: sup1.id,
      costPrice: 60, salePrice: 110, quantity: 15, minQuantity: 8, location: 'מדף A3',
    },
    {
      id: 'part-9', sku: 'TIM-BLT-001', name: 'רצועת טיימינג עם גלגלת', category: 'מנוע',
      manufacturer: 'Gates', supplierId: sup4.id,
      costPrice: 180, salePrice: 320, quantity: 2, minQuantity: 3, location: 'מדף D1',
      notes: 'כולל גלגלת מתיחה וגלגלת לחץ',
    },
    {
      id: 'part-10', sku: 'OXY-SEN-001', name: 'חיישן חמצן — פלטינום', category: 'חיישנים',
      manufacturer: 'Bosch', supplierId: sup4.id,
      costPrice: 95, salePrice: 170, quantity: 6, minQuantity: 4, location: 'מדף E1',
    },
  ]
  ...
  const q1 = await prisma.quote.upsert({
    ...
    update: {},
    create: {
      id: 'quote-1', quoteNumber: 'QT-2026-0001', status: 'SENT',
      laborHours: 3.5, laborRate: 150, partsTotal: 735, totalPrice: 1260,
      notes: 'כולל טיפול שמן, פילטרים, ורפידות בלם. תוקף ל-30 יום.',
  ...
  const q2 = await prisma.quote.upsert({
    ...
    update: {},
    create: {
      id: 'quote-2', quoteNumber: 'QT-2026-0002', status: 'APPROVED',
      laborHours: 2.0, laborRate: 150, partsTotal: 485, totalPrice: 785,
      notes: 'תיקון מיזוג אוויר — גז ומדחס.',
      validUntil: new Date('2026-06-10'),
      customerId: michal.id, vehicleId: mazda.id,
    },
  })
  ...
  const q3 = await prisma.quote.upsert({
    ...
    update: {},
    create: {
      id: 'quote-3', quoteNumber: 'QT-2026-0003', status: 'DRAFT',
      laborHours: 4.0, laborRate: 150, partsTotal: 540, totalPrice: 1140,
      notes: 'החלפת רצועת טיימינג מלאה כולל גלגלות.',
      validUntil: new Date('2026-07-01'),
      customerId: avi.id, vehicleId: civic.id,
    },
  })
